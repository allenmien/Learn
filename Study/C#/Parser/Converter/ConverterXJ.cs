...
{
    public class ConverterXJ : IConverter
    {
        ...
        string _http = "http://xj.gsxt.gov.cn";
        ...
        public SummaryEntity ProcessRequestAndParse(RequestInfo requestInfo)
        {
            ...
            {
                this._requestXml = new RequestXml(requestInfo.CurrentPath, "XJ" + "_API");
            }
            else
            {
                this._requestXml = new RequestXml(requestInfo.CurrentPath, "XJ");
            }
            ...
            if (urls != null)
            {
                ...
                foreach (var url in urls)
                {
                    ...
                    else if (url.StartsWith(http + "/gjjbj/gjjQueryCreditAction!zyryFrame.dhtml"))//主要人员
                    {
                        ...
                        request.Url = string.Format("http://xj.gsxt.gov.cn/gjjbj/gjjQueryCreditAction!zyryFrame.dhtml?flag=more&ent_id={0}&credit_ticket={1}",
                    ...
                    else if (url.StartsWith(http + "/gjjbj/gjjQueryCreditAction!fzjgFrame.dhtml"))//分支机构
                    {
                        ...
                        request.Url = string.Format("http://xj.gsxt.gov.cn/gjjbj/gjjQueryCreditAction!fzjgFrame.dhtml?flag=more&ent_id={0}&regno={1}&credit_ticket={2}",
