...
{
    public class ConverterHLJ : IConverter
    {
                ...
                foreach (HtmlNode rowNode in rows)
                {
                    ...
                    if (tdList != null && tdList.Count > 7)
                    {
                        ...
                        if (match != null && match.Success)
                        {
                            ...
                            var responseInfo = this._request.RequestData(new RequestSetting("get", "http://hl.gsxt.gov.cn/business/mortInfoDetail.jspx?id=" + id, "", "0", "dongchandiyaxiangqing"));
                                ...
                                if (match != null && match.Success && !string.IsNullOrEmpty(match.Value))
                                {
                                    ...
                                    if (!string.IsNullOrEmpty(id))
                                    {
                                        ...
                                        elements.Add(new RequestSetting("get",
                                            "http://hl.gsxt.gov.cn" + id, string.Empty, "0", "punishmentdetail"));
