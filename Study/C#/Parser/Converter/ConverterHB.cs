...
{
    public class ConverterHB : IConverter
    {
            ...
            if (tdList != null && tdList.Count > 3)
            {
                ...
                try
                {
                    if (!string.IsNullOrWhiteSpace(uuid))
                    {
                        ...
                        {
                            Method = "get",
                            Url = string.Format("http://he.gsxt.gov.cn/notice/notice/view_investor?uuid={0}", uuid),
                            IsArray = "0",
            ...
            if (tdList != null && tdList.Count > 3)
            {
                ...
                try
                {
                    if (!string.IsNullOrWhiteSpace(uuid))
                    {
                        ...
                        {
                            Method = "get",
                            Url = string.Format("http://he.gsxt.gov.cn/notice/notice/view_initiator?uuid={0}", uuid),
                            IsArray = "0",
                            Name = "investor_detials",
                            Data = ""
                        });
